...
Page({
    ...
    onShow : function () {
      var that = this;
      wx.request({
        url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/order/detail",
        data: {
      ...
      wx.showModal({
          ...
          success: function(res) {
            if (res.confirm) {
              wx.showLoading();
              wx.request({
                url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/order/delivery",
                data: {
                  token: app.globalData.token,
                  orderId: orderId
                },
    ...
    submitReputation: function (e) {
      ...
      wx.showLoading();
      wx.request({
        url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/order/reputation",
        data: {
