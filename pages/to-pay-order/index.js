...
Page({
  ...
  createOrder:function (e) {
    ...
    wx.request({
      url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/order/create",
      method:'POST',
      header: {
  ...
  initShippingAddress: function () {
    var that = this;
    wx.request({
      url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/user/shipping-address/default",
      data: {
  ...
  getMyCoupons: function () {
    var that = this;
    wx.request({
      url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/discounts/my",
      data: {
        token: app.globalData.token,
        status:0
      },
