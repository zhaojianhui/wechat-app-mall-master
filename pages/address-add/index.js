...
Page({
  ...
  bindSave: function(e) {
    ...
    wx.request({
      url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/user/shipping-address/"+apiAddoRuPDATE,
      data: {
  ...
  onLoad: function (e) {
    ...
    if (id) {
      ...
      wx.showLoading();
      wx.request({
        url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/user/shipping-address/detail",
        data: {
          token: app.globalData.token,
          id: id
        },
  ...
  deleteAddress: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: "https://api.it120.cc/2cecca99fe1c8f0d813c4a4e19eacf14/user/shipping-address/delete",
            data: {
              token: app.globalData.token,
              id: id
            },
